...
export function randomlySelectFromArray<T>(int: number, arr: T[]): T[] {
  const selected = []
  for (let i = 0; i < int; i++) {
...
export function generateRandomEmailDomain(): string {
...
export function generateRandomThoughts(int: number, userId: Types.ObjectId, username: string) {
...
export function generateRandomReactions(int: number) {
